...
class BlockchainController {
    ...
    constructor(app, blockchainObj) {
        ...
        console.log("DB: Blockchain controller created");
    }

    // Enpoint to Get a Block by Height (GET Endpoint)
    getBlockByHeight() {
            console.log("enter BlockchainController.js  getBlockByHeight ");
            ...
            if(req.params.height) {
                ...
                if(block){
                    ...
                    return res.status(404).send("gBBHeight404:Block Not Found!");
                }
            } else {
    ...
    requestOwnership() {
            console.log("enter BlockchainController.js  requestOwnership ");
            ...
            if(req.body.address) {
                ...
                if(message){
                    ...
                    return res.status(500).send("ROwners500:An error happened!");
                }
            } else {
    ...
    submitStar() {
            ...
            if(req.body.address && req.body.message && req.body.signature && req.body.star) {
                console.log("enter BlockchainController.js  submit star ");
                const address = req.body.address;
                ...
                try {
                    ...
                    if(block){
                        console.log("yes good block and submitted")
                        return res.status(200).json(block);
                    } else {
                        console.log("no block..not submited")
                        return res.status(500).send("SubmitSat500: An error happened!");
                    }
                } catch (error) {
    ...
    getBlockByHash() {
            console.log("enter BlockchainController.js  getBlockByHash ");
            ...
            if(req.params.hash) {
                ...
                if(block){
                    ...
                    return res.status(404).send("gBBHash404:Block Not Found!");
                }
            } else {
                return res.status(404).send("gBBH404:Block Not Found! Review the Parameters!");
            }
    ...
    getStarsByOwner() {
            console.log("enter BlockchainController.js  getStarByOwner ");
            ...
            if(req.params.address) {
                ...
                try {
                    ...
                    if(stars){
                        ...
                        return res.status(404).send("GBBOwner404:Block Not Found!");
                    }
                } catch (error) {
                    return res.status(500).send("GBBOwner404500:An error happened!");
                }
            } else {
                return res.status(500).send("500: Block Not Found! Review the Parameters!");
            }
